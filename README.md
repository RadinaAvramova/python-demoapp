...
```
git clone https://github.com/RadinaAvramova/python-demoapp.git
```
...
Public container image is [available on GitHub Container Registry](https://github.com/users/RadinaAvramova/packages/container/package/python-demoapp)

Run in a container with:

```bash
docker run --rm -it -p 5000:5000 ghcr.io/RadinaAvramova/python-demoapp:latest
```
